  ...
  return (
    <div className="pt-5 pb-10">
      <h2 className="text-4xl font-bold text-center">
        About<span className="text-[#F3601A] text-center"> HomeHero</span>
      </h2>
      ...
      <section className="space-y-32">
        ...
        <div className="grid md:grid-cols-2 gap-20 items-start">
          <div className="space-y-6 text-gray-500 leading-relaxed text-xl">
            <p>
              <span className="font-semibold text-[#F3601A]">HomeHero</span> is
              a modern all-in-one home service platform where users can easily
              book essential services without leaving their home.
            </p>
            <p>
              Everything you need is available in one centralized system. Users
              can browse, compare, and select services based on price, reviews,
              or professional ratings.
            </p>
            <p>
              Our mission is to create a reliable, fast, and secure digital
              service ecosystem powered by skilled professionals.
            </p>
            <p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-500 leading-relaxed text-lg">
            Our vision is to become the most trusted digital home service
            platform by continuously improving service quality, expanding
            coverage, and delivering exceptional user experiences through
            technology.
          </p>
          <p className="text-gray-500 leading-relaxed text-lg">
            We aim to introduce AI-based scheduling, instant service
            recommendations, and personalized offers to enhance every user's
            experience.
          </p>
          <p className="text-gray-500 leading-relaxed text-lg">
            Our goal is to save time, reduce stress, and make home services
