  ...
  return (
    <div className="pt-5 pb-10">
      <h2 className="text-4xl font-bold text-center">
        <span className="text-[#F3601A] text-center">Terms & </span>Privacy
      </h2>
      <p className="text-gray-600 mb-6 text-lg text-center">
        Welcome to HomeHero’s Terms of Service and Privacy Policy. Learn how we
        operate, what we expect from users, and how your data is protected.
      </p>
      <section className="space-y-48">
        <div className="text-center max-w-3xl mx-auto space-y-8">
          <p className="text-gray-500 text-md md:text-lg  leading-relaxed">
            Using our services indicates agreement with these terms and
            policies. Transparency, security, and user satisfaction are our
            priorities.
          </p>
        </div>
        ...
        <div className="space-y-32">
          ...
          <div className="space-y-20">
            {[
              ...
              {
                icon: (
                  <FaCheckCircle className="text-[#F3601A] text-5xl mt-1" />
                ),
        ...
        <div className="space-y-28">
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div className="space-y-6">
              ...
              <p className="text-gray-500 text-lg leading-relaxed">
                All services listed on HomeHero include clear pricing,
                descriptions, and expected timeframes. Users can compare options
                before booking.
              </p>
              <p className="text-gray-500 text-lg leading-relaxed">
                Ratings and reviews are publicly visible, ensuring transparency
                and trustworthiness.
              </p>
            </div>
            <div className="space-y-6">
              ...
              <p className="text-gray-500 text-lg leading-relaxed">
                Our support team is available 24/7 to answer queries, resolve
                complaints, and assist users promptly.
              </p>
              <p className="text-gray-500 text-lg leading-relaxed">
                Users are encouraged to provide feedback to improve the platform
                continuously.
              </p>
            </div>
          </div>
        ...
        <div className="text-center pt-28 border-t border-gray-300">
          <p className="text-sm text-gray-500">
            HomeHero — committed to providing secure, transparent, and reliable
            home services for all users.
          </p>
        </div>
      </section>
    </div>
